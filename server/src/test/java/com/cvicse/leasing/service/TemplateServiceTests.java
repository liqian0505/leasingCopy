...
//        Template template1=new Template(jsonObject);
//        template1.setId("1");
//        JSONObject jsonObject1 = new JSONObject();
//        jsonObject1.put("content","T2");
//        Template template2 = new Template(jsonObject1);
//        template2.setId("2");
...
//        Mockito.when(repository.save(new Template(jsonObject2))).thenReturn(template2);
...
//        JSONObject jsonObject1 = new JSONObject();
//        jsonObject1.put("content","T2");
//        templateService.createTemplate(new Template(jsonObject1));
...
//        JSONObject jsonObject1 = new JSONObject();
//        jsonObject1.put("content","T2");
//        Template template =templateService.updateTemplate(jsonObject1,"1");
