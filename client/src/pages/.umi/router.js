...
import RendererWrapper0 from '/Users/ics/Documents/repos/leasing/client/src/pages/.umi/LocaleWrapper.jsx'
...
const routes = [
  {
    ...
    ? _dvaDynamic({
      ...
      LoadingComponent: require('/Users/ics/Documents/repos/leasing/client/src/components/PageLoading/index').default,
    })
    ...
    : require('../TemplateList').default,
      ...
      {
        "component": () => React.createElement(require('/Users/ics/Documents/repos/leasing/client/node_modules/umi-build-dev/lib/plugins/404/NotFound.js').default, { pagesPath: 'src/pages', hasRoutesInConfig: true })
      }
    ]
  },
  {
